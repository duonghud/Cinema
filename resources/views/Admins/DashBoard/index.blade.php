        ...
        <div class="col-md-6 col-xl-3">
            <div class="card dashboard-card h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('admine.movies.index') }}" class="text-decoration-none">Xem danh sách phim</a>
                </div>
            </div>
        </div>
            ...
            <div class="card section-card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('admine.movies.index') }}" class="small text-decoration-none">Quản lý phim</a>
                    </div>
