...
<div class="container-fluid mt-4 px-4">
    ...
    <form action="{{ route('screeningRoom.update', $room->roomID) }}" method="POST" id="roomForm">
        @csrf
        @method('PUT')

        <div class="action-bar">
            <div class="room-title-preview">Chỉnh sửa: <span id="barRoomName">{{ $room->roomName }}</span></div>
            <div class="d-flex align-items-center gap-2">
                ...
                <button type="submit" class="btn-save" id="submitBtn" style="padding:7px 16px;font-size:13px">Cập nhật phòng</button>
            </div>
        </div>
